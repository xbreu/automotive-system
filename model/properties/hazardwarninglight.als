...
// a new flashing cycle can occur. Note: By the fact, that a flashing cycle
// must always be completed, a "switching" behavior of the indicator is
// avoided. Thus, for example a change of the pitman arm from "tip-blinking" to
// "direction blinking" or back has no visible effect.
check {
